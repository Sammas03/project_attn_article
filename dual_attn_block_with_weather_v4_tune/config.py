...
p1 = {
    ...
    "common.block_num": 6,  # 长周期使用的天数 可调整参数
    "common.block_len": 4,  # 长时序使用的序列长度 可调整参数
    ...
    "input_encoder.output_size": 128,# 可训练参数
...
p2['input_encoder.output_size'] = tune.randint(32, 128)
