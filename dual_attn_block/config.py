...
p1 = {
    ...
    # 输入attention 编码器网络参数
    "input_encoder.hidden_size": 512,  # lstm 的input_size 跟输入的long_days 保持一致
    ...
    "temporal_decoder.hidden_size": 1024,
    "temporal_decoder.num_layers":1,
    # 子网参数
    "group.user_count": 16,
    "group.hidden_size":64, #attn层的全连接大小
    "group.output_size": 128,
